...
/*
 ...
 mostrar a diagonal secundaria da matriz.
*/
void diagonalSecMatriz()
{
    //definir dados
    int dimensao;
    ...
    for (int i = 0; i < dimensao; i++)
    {
        ...
        printf("A diagonal secundaria da matriz quadrada e :\n");
    //imprimir matriz
    for (int i = 0; i < dimensao; i++)
    {
        for (int j = 0; j < dimensao; j++)
...
}//end diagonalSecMatriz()

//Funcao principal
int main(void)
{
    //identificar
    IO_id("EXEMPLO0914 - v0.1");
    diagonalSecMatriz();
    return 0;
}