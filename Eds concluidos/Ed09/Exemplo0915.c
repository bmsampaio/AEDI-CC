...
/*
 ...
 mostrar os elementos abaixo e na diagonal principal da matriz.
*/
void abaixoDiagonal()
{
    //definir dados
    ...
    for (int i = 0; i < dimensao; i++)
    {
        ...
        printf("Elementos abaixo e na diagonal principal sao :\n");
    //imprimir matriz
    for (int i = 0; i < dimensao; i++)
    {
        for (int j = 0; j < dimensao; j++)
