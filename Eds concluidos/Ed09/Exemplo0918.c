...
/*
 ...
 mostrar elementos acima na diagonal secundaria da matriz.
*/
void acimaDiagonalSec()
{
    //definir dados
    int dimensao;
    ...
    for (int i = 0; i < dimensao; i++)
    {
        ...
        printf("\n");
         ...
         printf("Elementos acima e na diagonal secundaria sao :\n");
    //imprimir matriz
    for (int i = 0; i < dimensao; i++)
    {
        for (int j = 0; j < dimensao; j++)
...
}//end acimaDiagonalSec()

//Funcao principal
int main(void)
{
    //identificar
    IO_id("EXEMPLO0918 - v0.1");
    acimaDiagonalSec();
    return 0;
}